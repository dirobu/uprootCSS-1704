...
function nav(action){
	...
	if(action == 'open'){
		if(a){a.outerHTML='';}
		var html = '<div id="nav-menu" class="back-black text-cloud"><h1 id="nav-btn" class="disp-right" onclick="nav();"><i class="fa fa-bars" aria-hidden="true"></i></h3>'+navbar.innerHTML+'</div>';
